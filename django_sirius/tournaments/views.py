...
def get_list_page(entity_name, file_path='list.html', page_info=PAGES):
    ...
    def list_page(request):
        return render(request, file_path, context={'entities': entity['model'].objects.all(), 'title': entity['list_link'][0], 'fields': entity['primary_fields'], 'link': entity['entity_link'][1], 'entity_name': entity['entity_link'][0], 'user': request.user, 'create': entity['form_link'][0]})
    return list_page
...
def get_create_page(entity_name, form_class, file_path='form.html', page_info=PAGES):
    entity = page_info[entity_name]
...
def get_update_page(entity_name, form_class, file_path='form.html', page_info=PAGES):
    entity = page_info[entity_name]
